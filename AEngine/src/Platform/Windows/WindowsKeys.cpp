...
namespace AEngine
{
	...
	static const std::map<int, AEMouse> mouseMap = {
		...
		{GLFW_MOUSE_BUTTON_LAST,   AEMouse::BUTTON_LAST},
		{GLFW_MOUSE_BUTTON_LEFT,   AEMouse::BUTTON_1},
		{GLFW_MOUSE_BUTTON_RIGHT,  AEMouse::BUTTON_2},
		{GLFW_MOUSE_BUTTON_MIDDLE, AEMouse::BUTTON_3}
	};
